      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8">
          ...
          <div className="space-y-6">
            <Link
              href="/"
              className="font-display text-2xl font-bold tracking-wide text-secondary-light"
            >
              ALPHA ZETA
            </Link>
            <p className="text-secondary/60 max-w-sm leading-relaxed">
              A professional business fraternity at the University of Southern California,
              dedicated to fostering brotherhood, professional excellence, and community service.
            </p>
            {/* Social Links */}
          ...
          <div className="grid grid-cols-2 gap-8 md:justify-end">
            <div>
              <h3 className="font-display text-sm font-semibold text-secondary-light mb-4 tracking-wide uppercase">
                Navigation
              </h3>
        ...
        <div className="mt-12 pt-8 border-t border-secondary/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-secondary/40 text-sm">
            &copy; {new Date().getFullYear()} Alpha Zeta USC. All rights reserved.
          </p>
          <p className="text-secondary/40 text-sm">
