    ...
    <section className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-wide text-secondary-light mb-6">
            WHO WE ARE
          </h2>
          ...
          <p className="text-lg md:text-xl text-secondary/70 leading-relaxed">
            ...
            strive to empower our brothers to excel in their careers, foster
            lifelong friendships, and advance in every aspect of their lives.
          </p>
        </div>
      </div>
    </section>
