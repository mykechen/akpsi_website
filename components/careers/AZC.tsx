...
const benefits = [
  {
    ...
    description:
      "Learn about consulting as an industry, what the job entails, and the opportunities available.",
  },
  {
    title: "Casing",
    description:
      "Through hands-on workshops, learn the foundations of case interviews: market sizing, frameworks, analysis, and brainstorming.",
  },
  {
    title: "Recruiting Prep",
    description:
      "Get a detailed timeline of what you can do to maximize your chances at success in consulting recruitment.",
  },
  {
    title: "Networking",
    description:
  ...
  },
  {
    ...
    description:
      "Receive guidance on how to best prepare for consulting interviews, including mock interviews and feedback.",
  },
];
...
export default function AZC() {
  ...
  return (
    <section id="azc" ref={ref} className="py-24 md:py-40 bg-white scroll-mt-20">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-secondary-dark/70 text-lg">
                Build the analytical and problem-solving skills to excel in
                consulting.
              </p>
            </div>
