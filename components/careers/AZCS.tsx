...
const benefits = [
  {
    ...
    description:
      "Master foundational concepts of computer science, including algorithms, data structures, and problem-solving techniques.",
  },
  {
    title: "Leetcode & Interview Prep",
    description:
      "Prepare for coding interviews with hands-on practice on Leetcode, focusing on algorithmic challenges and whiteboard exercises.",
  },
  {
    title: "Recruiting",
    description:
      "Get detailed insights into recruiting strategies, building a strong resume, and landing top technical roles.",
  },
  {
    title: "Practical Research in ML",
    description:
      "Engage in machine learning research and complete a paper by semester's end to enhance your technical portfolio.",
  },
  {
...
export default function AZCS() {
  ...
  return (
    <section id="azcs" ref={sectionRef} className="py-24 md:py-40 bg-white">
          ...
          <div ref={leftColRef} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-secondary-dark/70 text-lg">
                Build technical skills and land top roles in the tech industry.
              </p>
            </div>
