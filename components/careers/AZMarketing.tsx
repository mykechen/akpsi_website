...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Learn the foundations of user interface and user experience design to create intuitive digital experiences.",
  },
  {
    title: "Creative Portfolio",
    description:
      "Develop a portfolio throughout the semester to effectively display creative works for recruitment.",
  },
  {
    title: "Digital Marketing Channels",
    description:
      "Dive into various digital marketing channels including social media, email, and content marketing.",
  },
  {
    title: "Consumer Behavior",
    description:
      "Understand the motivations and decision-making processes of consumers to create targeted strategies.",
  },
];
...
export default function AZMarketing() {
  ...
  return (
    <section id="azmarketing" ref={ref} className="py-24 md:py-40 bg-white scroll-mt-20">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-secondary-dark/70 text-lg">
                Build creative and analytical skills for marketing and design
                roles.
              </p>
            </div>
